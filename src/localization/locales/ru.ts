    ...
    export const templates = {
      's182ab2d6c997515f': `Добавьте его на главный экран чтобы получить дополнительные возможности и удобство
          использования.`,
...
'sba52286c21552a4e': `Установите это на ваше устройство чтобы получить дополнительные возможности и
          удобство использования.`,
'sc79fd7641eb9a975': `Спрятать Инструкцию`,
'scdaf4bbff76674c8': `На экран «Домой»`,
'sdfe23506a3b0cdc8': `1) Открыть в Safari браузере`,
'se740f75b95a51807': `Добавьте его в Dock чтобы получить дополнительные возможности и удобство
          использования.`,
