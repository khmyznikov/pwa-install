        ...
        <aside id="pwa-install">
            <article class="install-dialog apple ${classMap(installDialogClassesApple())} dialog-body">
                ...
                <div class="welcome-to-install">
                    This website has app functionality. Add it to your Home Screen for reach experience and easy access.
                </div>
                <div class="how-to-body">
                    <div class="how-to-description">
                        ...
                        <div class="description-step">
                            ...
                            <div class="step-text">3) Press Add to Home Screen</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="action-buttons">
                    ...
                    <button class="dialog-button button install" @click=${howToForApple}>
                        <span class="${howToRequested? 'show': 'hide'}">Hide Instruction</span>
                        <span class="${howToRequested? 'hide': 'show'}">Add to Home Screen</span>
                    </button>
                </div>
            </article>
        </aside>`;
