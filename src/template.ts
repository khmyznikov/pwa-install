...
const template = (name: any, description: any) => html`
<div id="pwa-install">
    <div class="install-dialog chrome" :class="{available: installAvailable}">
        <div class="dialog-body">
            <div class="icon">
                <img :src="dialog.icon" alt="icon" class="icon-image">
            </div>
            <div class="about">
    ...
    <div class="install-dialog apple" :class="{available: appleInstallAvailable, 'how-to': howToRequested}">
        <div class="dialog-body">
            <div class="icon">
                <img :src="dialog.icon" alt="icon" class="icon-image">
            </div>
            <div class="about">
                ...
                <div class="description">{{dialog.description}}</div>
            </div>
            <div class="action-buttons">
